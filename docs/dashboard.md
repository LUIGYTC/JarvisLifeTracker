...
- daily: fecha, ingresos, gastos; todas las fechas con movimientos en orden ascendente.
- recent: hasta 20 movimientos, fecha+hora descendente. Solo fecha, hora, tipo,
  categoria, monto, descripcion y metodo.
...
es ingresos menos gastos. No se redondean importes con más de dos decimales.
...
contener Fecha, Hora, Tipo, Categoría, Monto, Descripción, Método en ese orden.
...
como 01/02/2026 no se interpretan automáticamente. Tipo: Gasto/Ingreso exactos.
...
La lectura usa valueRenderOption=FORMULA para detectar fórmulas en los campos
visibles y rechazarlas; no se devuelven al navegador ni se muestran resultados
parciales. Una fila inválida produce un error genérico para evitar totales engañosos.
